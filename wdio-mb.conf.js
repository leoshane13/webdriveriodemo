...
exports.config = {
    ...
    capabilities: [{
        ...
        build: "CL JP Automation Test",
		name: "CL JP Registration for Mobile on " + tools.getEnv(),
		platform: "Android",
    ...
    onComplete: function(exitCode, config, capabilities, results) {
        ...
        report.generate({
            ...
            customData: {
                title: 'Run info',
                data: [
                    {label: 'Project', value: 'CL JP Automation on Android'},
