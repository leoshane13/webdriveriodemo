...
exports.config = {
    ...
    capabilities: [{
        ...
        // name: "Automation Test on" + tools.getEnv(),
        ...
        // proxy: {
        //     proxyType: "manual",
        //     httpProxy: "https://global-jp.link.ac.cn:443",
        //     socksUsername: "seshio",
        //     socksPassword: "subaruku",
    ...
    // services: ['chromedriver','lambdatest'],
    ...
    afterFeature: async function (uri, feature) {
        // browser.execute('lambda-name=' + feature.name);
    },
    ...
    onComplete: async function(exitCode, config, capabilities, results) {
        ...
        report.generate({
            ...
            'cjson:metadata':{
                browser: {
                    name: capabilities[0].browserName,
            ...
            customData: {
                title: 'Run info',
                data: [
                    {label: 'Project', value: 'Automation on PC'},
                    {label: 'Environments', value: tools.getEnv()},
                    {label: 'Execution Start Time', value: teststarttime},
